import svgPaths from "./svg-x1yrxv6cu6";
...
function Parragraph() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0 w-full" data-name="Parragraph">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] min-w-px relative text-[#2d353c] text-[14px]" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function List() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="list">
      <svg className="absolute block inset-0 size-full" fill="none" height="20" preserveAspectRatio="none" viewBox="0 0 20 20" width="20">
        <g id="list">
          <path clipRule="evenodd" d={svgPaths.p38df880} fill="var(--fill-0, #979797)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Container2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="container">
      <div className="absolute bg-[#d9e7fd] h-[22px] left-[797px] top-0 w-[188px]" />
...
function FormatTools1() {
  return (
    <div className="relative shrink-0 w-full" data-name="Format tools">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pr-[16px] relative size-full">
          ...
          <div className="content-stretch flex items-center justify-center relative rounded-[4px] shrink-0 size-[32px]" data-name="Icon/Actions/trash">
            <Trash />
          </div>
        </div>
      </div>
...
function FormatTools() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-center left-[926px] p-[8px] rounded-[4px] top-[-12px] w-[248px]" data-name="Format tools">
      <div aria-hidden className="absolute border border-[#dadce0] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <FormatTools1 />
      <div className="absolute bg-white content-stretch flex flex-col items-start left-[104px] py-[6px] top-[48px] w-[104px]" data-name="Dropdown Menu">
        <div aria-hidden className="absolute border border-[#dadce0] border-solid inset-[-1px] pointer-events-none" />
...
function Parragraph1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-end pt-[48px] relative shrink-0 w-full" data-name="Parragraph">
      <Container2 />
      <div className="absolute left-[973px] overflow-clip size-[24px] top-[46px]" data-name="Cursor/Text">
        <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[15.921px] items-center justify-center left-[calc(50%-0.04px)] top-[calc(50%-0.47px)] w-[7.064px]">
          <div className="flex-none rotate-90">
            <div className="h-[7.064px] relative w-[15.921px]" data-name="beam">
              <div className="absolute inset-[-15.02%_-6.28%_-15.05%_-6.28%]">
                <svg className="block size-full" fill="none" height="9.1872" preserveAspectRatio="none" viewBox="0 0 17.9214 9.1872" width="17.9214">
                  <path d={svgPaths.pee8c000} fill="var(--fill-0, black)" id="beam" stroke="var(--stroke-0, white)" />
                </svg>
              </div>
            </div>
          </div>
