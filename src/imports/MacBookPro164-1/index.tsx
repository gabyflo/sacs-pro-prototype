import svgPaths from "./svg-c4ntp5eeyk";
...
function Table() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="table">
      <svg className="absolute block inset-0 size-full" fill="none" height="20" preserveAspectRatio="none" viewBox="0 0 20 20" width="20">
        <g clipPath="url(#clip0_29_2920)" id="table">
          <path d={svgPaths.p9537900} fill="var(--fill-0, #373737)" id="Vector" />
        </g>
        <defs>
          <clipPath id="clip0_29_2920">
            <rect fill="white" height="20" width="20" />
          </clipPath>
        </defs>
      </svg>
...
function Tools() {
  return (
    <div className="content-stretch flex items-start justify-center relative shrink-0 w-full" data-name="Tools">
      <div className="content-stretch flex items-center justify-center relative shrink-0 size-[32px]" data-name="Icon/Data & Charts/table">
        <Table />
      </div>
      <div className="content-stretch flex flex-col items-start p-[8px] relative shrink-0 w-[32.001px]" data-name="Icon/Text Editor/eyedropper">
        <div className="h-[15.997px] relative shrink-0 w-[16.001px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" height="15.9971" preserveAspectRatio="none" viewBox="0 0 16.0014 15.9971" width="16.0014">
            <path d={svgPaths.p1a6a1f00} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="content-stretch flex items-center justify-center overflow-clip p-[3px] relative shrink-0 size-[32px]" data-name="Icon/Text Editor/align-left">
        <div className="relative shrink-0 size-[14px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" height="14" preserveAspectRatio="none" viewBox="0 0 14 14" width="14">
            <path d={svgPaths.p67e7480} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="content-stretch flex items-center justify-center overflow-clip px-[4px] py-[3px] relative shrink-0 size-[32px]" data-name="Icon/Text Editor/a">
        <div className="h-[13.999px] relative shrink-0 w-[11.995px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" height="13.9992" preserveAspectRatio="none" viewBox="0 0 11.9952 13.9992" width="11.9952">
            <path d={svgPaths.p37756b10} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[2px] py-[5px] relative shrink-0 size-[32px]" data-name="Icon/Text Editor/text-height">
        <div className="h-[16px] relative shrink-0 w-[20px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 20 16" width="20">
            <path d={svgPaths.p20d00520} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="relative shrink-0 size-[32px]" data-name="Icon/Text Editor/brush">
        <Brush />
      </div>
      ...
      <div className="relative shrink-0 size-[32px]" data-name="Icon/Text Editor/bold">
        <Bold />
      </div>
      <div className="relative shrink-0 size-[32px]" data-name="Icon/Text Editor/italic">
        <Italic />
      </div>
      <div className="relative shrink-0 size-[32px]" data-name="Icon/Text Editor/underline">
        <Underline />
      </div>
      <div className="content-stretch flex items-center justify-center relative shrink-0 size-[32px]" data-name="Icon/Content & Files/link">
        <Link />
      </div>
      <div className="relative shrink-0 size-[32px]" data-name="Icon/Content & Files/code">
        <Code />
      </div>
      <div className="content-stretch flex items-center justify-center relative shrink-0 size-[32px]" data-name="Icon/Actions/trash">
        <Trash />
      </div>
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-px py-[2px] relative shrink-0 size-[32px]" data-name="Icon/Text Editor/highlighter">
        <div className="h-[16px] relative shrink-0 w-[17px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 17 16" width="17">
            <path d={svgPaths.p1940d400} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="overflow-clip relative shrink-0 size-[32px]" data-name="Icon/Text Editor/html">
        <div className="absolute inset-[15%_20%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" height="22.4" preserveAspectRatio="none" viewBox="0 0 19.2 22.4" width="19.2">
            <path d={svgPaths.p1dbdf400} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
